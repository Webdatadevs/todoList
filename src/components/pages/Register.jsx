                    ...
                    >
                        <FormControl width={"100%"} marginTop={"30px"}>
                            ...
                            <InputGroup>
                                ...
                                <InputRightElement background={'dodgerblue'} borderRadius={'5px'} borderTopLeftRadius={"0px"}
                        ...
                        {/* <FormControl width={"100%"} marginTop={"30px"}>
                            ...
                            >
                                {emailButton
                                    ? "РЕГИСТРАЦИЯ ЧЕРЕЗ ТЕЛЕФОН НОМЕРУ"
                                    : "РЕГИСТРАЦИЯ ЧЕРЕЗ ЭЛУТРОННУЮ ПОЧТУ"}
                            </Button>
                        </FormControl> */}
                        <NavLink to={"/login"} className={'w-full mt-[30px] '}  >
                            <Button
                                type="submit"
                                width={"100%"}
                                _active={{
